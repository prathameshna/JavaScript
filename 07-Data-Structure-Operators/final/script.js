...
console.log('Prathamesh Nadhe'.split(' '));

const [firstName, lastName] = 'Prathamesh Nadhe'.split(' ');
...
capitalizeName('saurabh sanjay galande');
capitalizeName('prathamesh nadhe');

// Padding
const massage = 'Go to gate 23!';
console.log(massage.padStart(25, '+').padEnd(35, '+'));
console.log('Pratham'.padStart(25, '+').padEnd(35, '+'));
console.log(massage.padEnd(25, '+'));
console.log('Pratham'.padEnd(25, '+'));
...
console.log(markCreditCard(789654123019));
console.log(markCreditCard('896544752123658'));
...
console.log('Pratham'.toUpperCase());
...
const loginEmail = '    Pratham@Gmail.Com \n';
...
const checkMiddlerSeat = function (seat) {
...
checkMiddlerSeat('11B');
checkMiddlerSeat('23C');
checkMiddlerSeat('3E');

console.log(new String('Pratham'));
console.log(typeof new String('Pratham'));
console.log(typeof new String('Pratham').slice(1));
...
console.log(new Set('Prathamesh'));
...
console.log(new Set('PrathameshNadhe').size);
...
console.log('---- AND ----');
console.log(0 && 'Pratham');
console.log(7 && 'Pratham');

console.log('Hello' && 24 && null && 'Pratham');
...
// SPREAD, because on aRIGHT side of =
const arr = [1, 2, ...[3, 4]];
